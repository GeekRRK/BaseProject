...
- (void)shareInView:(UIView *)view {
    ...
    //2、分享
    [ShareSDK share:SSDKPlatformTypeAny parameters:shareParams onStateChanged:^(SSDKResponseState state, NSDictionary *userData, SSDKContentEntity *contentEntity, NSError *error) {
