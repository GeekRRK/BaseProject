...
@interface MeVC () <JSDropDownMenuDataSource,JSDropDownMenuDelegate> {
...
- (void)viewDidLoad {
    ...
    _data2 = [NSMutableArray arrayWithObjects:@"智能", @"离我最近", @"评价最高", @"最新发布", @"人气最高", @"价格最低", @"价格最高", nil];
    _data3 = [NSMutableArray arrayWithObjects:@"不限", @"单人餐", @"双人餐", @"3~4人餐", nil];
